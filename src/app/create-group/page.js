...
import { Form, Input, DatePicker, TimePicker, InputNumber, Select, Checkbox, Button, Space, Row, Col, message, Typography } from 'antd'
...
const CreateGroup = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 border border-gray-300 rounded-lg shadow-md">
      <Title level={1} className="mb-6" style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '2.5rem' }}>
        Create a Group
      </Title>
      <Form
        form={form}
      ...
      >
        <Form.Item
          name="name"
          label={<span style={{ fontFamily: 'Desktop/LG, sans-serif' }}>Name Your Group</span>}
          rules={[{ required: true, message: 'Please name your group!' }]}
        >
          <Input placeholder="My Study Group" />
        </Form.Item>

        <Form.Item label={<span style={{ fontFamily: 'Desktop/LG, sans-serif' }}>Where Are You Studying?</span>}>
        ...
        <Form.Item label={<span style={{ fontFamily: 'Desktop/LG, sans-serif' }}>When Are You Studying?</span>} className="mb-2">
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
            <span style={{ marginRight: '8px', fontFamily: 'Desktop/LG, sans-serif' }}>Start Now</span>
        ...
        <Form.Item
          ...
          label={
            <span style={{ fontFamily: 'Desktop/LG, sans-serif' }}>
              Group Size Limit <span style={{ color: 'rgba(0,0,0,0.45)', fontSize: '0.9em' }}>(optional)</span>
            </span>
          }
        >
        ...
        <Form.Item
          name="studySubjects"
          label={<span style={{ fontFamily: 'Desktop/LG, sans-serif' }}>What Are You Studying?</span>}
